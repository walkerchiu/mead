...
import { SessionStatus, RevokedMethod } from './admin-session.types';
...
export class SessionFiltersInput {
  @Field(() => String, { nullable: true, description: '用戶 ID' })
  @IsOptional()
  @IsString()
  userId?: string;
