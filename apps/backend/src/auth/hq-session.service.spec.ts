...
import { SessionStatus } from './hq-session.types';

describe('HQSessionService', () => {
  let service: HQSessionService;
  ...
  const mockCacheService = {
    invalidateSessionStats: jest.fn().mockResolvedValue(undefined),
    cacheSessionStats: jest.fn().mockResolvedValue(undefined),
    getCachedSessionStats: jest.fn().mockResolvedValue(null),
  };
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        },
        {
          ...
          useValue: {
            createLocalizedNotification: jest.fn(),
            createBulkLocalizedNotifications: jest.fn(),
          },
        },
        {
          ...
          useValue: {
            ...
            getRequestIdOrGenerate: jest
              .fn()
              .mockReturnValue('00000000-0000-7000-8000-000000000000'),
          },
        },
      ],
    }).compile();

    service = module.get<HQSessionService>(HQSessionService);
  });
  ...
  describe('revokeSession', () => {
    ...
    it('should send email notification when requested', async () => {
      ...
      mockPrismaService.user.findUnique.mockResolvedValue(mockHQ);
