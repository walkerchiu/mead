...
export const NetworkError: Story = {
  args: {
    title: 'Network Error',
    message:
      'Failed to load the portal resources. Please check your internet connection and try again.',
    severity: 'error',
    showRetry: true,
    retryText: 'Retry',
...
export const DataLoadFailed: Story = {
  args: {
    ...
    message:
      'Unable to load the plan data. This might be due to a temporary network issue.',
    severity: 'error',
    showRetry: true,
    retryText: 'Reload',
  },
...
export const WithMultipleActions: Story = {
  args: {
    ...
    message: 'The page data is unavailable. You can retry or return home.',
    severity: 'warning',
    showRetry: true,
    retryText: 'Retry',
    action: (
...
export const RealWorldNetworkError: Story = {
  render: function NetworkErrorExample() {
    ...
    return (
      <ErrorDisplay
        title="Unable to Load Portal Resources"
