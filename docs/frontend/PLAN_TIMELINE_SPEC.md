...
- 軌道只以長條／圓點標示事件「位置」，不常駐顯示所有文字。
- 預設顯示「當下期程」（涵蓋今日月份的事件）的 tooltip；當前月份於月份軸以底色標示。
- 桌機 hover／鍵盤 focus、行動裝置點擊某事件時，顯示該事件 tooltip（含 `dateLabel`、
  `title`、`note`），離開後回到當下期程。
- 年度以左上角下拉選單切換（多年度計畫，如菁培含 2026／隔年 2027）。
...
- **菁培（sposad）**：2026 年（簡章公告及受理報名 3–5 月／報名截止及國內初審 6 月／
  國內研習營 7 月／國內複審 12 月）＋隔年 2027（海外決選 1–5 月／出發 9 月）。
- **戰國策（idc）**：2026 年（校園巡迴展 3–5 月／專題講座 3-5 月／獎勵金申請 6–7 月／
